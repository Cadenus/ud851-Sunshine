...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadWeatherData("Cologne,Germany");
    }
    ...
    class FetchWeatherTask extends AsyncTask<URL, Void, String> {
        ...
        protected String doInBackground(URL... urls) {
            ...
            try{
                ...
                Log.e("MainActivity", "An error occurred fetching the data from ["+urls[0].toString()+"].", e);
            }
        ...
        protected void onPostExecute(String weatherDataString) {
            if(null != weatherDataString && !"".equals(weatherDataString)) {
                mWeatherTextView.setText(weatherDataString);
            }
        }
    }
}